...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="userafterlogin.php" id="logo"><img src="images/logo2.png" style="width: 20%; border-radius: 80px;"></a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="userafterlogin.php">Home</a></li>
                    <li class="nav-item"><a class="nav-link" href="shop-1.php">Shop</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="about-2.php">About</a></li>
                    <li class="nav-item"><a class="nav-link" href="contact-2.php">Contacts</a></li>
